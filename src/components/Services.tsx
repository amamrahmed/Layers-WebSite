...
const services = [
  ...
  },
  {
    ...
    description:
      "High-quality printing services from business cards to large-format displays.",
    color: "#FFD700",
  },
  {
    icon: TrendingUpIcon,
  ...
  },
  {
    ...
    description:
      "Compelling video content that tells your story and captivates audiences.",
    color: "#FFD700",
  },
  {
    icon: PackageIcon,
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative p-8 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl hover:border-white/30 transition-all duration-300 cursor-pointer"
                whileHover={{ y: -8 }}
              >
                <div
                ...
                <h3 className="text-2xl font-bold mb-4 text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-[#FFE57F] group-hover:via-[#FFD700] group-hover:to-[#FFB800] group-hover:bg-clip-text transition-all duration-300">
                  {service.title}
                </h3>
